#Kyele
#来自：https://raw.githubusercontent.com/vs194/tvbox/main/drpy_js/熊猫.py
#来自：https://github.com/su147456888444/tvbox/raw/main/18.txt
import sys
import json
import time
import re
...
class Spider(Spider):
    ...
    def detailContent(self, ids):
        ...
        vod = {"vod_id": vid, "vod_name": title, "vod_pic": "", "type_name": "LIVE", "vod_year": "", "vod_area": "", "vod_remarks": "PandaLive", "vod_actor": "", "vod_director": "", "vod_content": title, "vod_play_from": "书生玩剣ⁱ·*₁＇", "vod_play_url": f"名妓读领ⁱ·*₁＇${vid}"}
        return {"list": [vod]}
